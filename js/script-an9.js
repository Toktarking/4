...
if (localStorage.getItem(`${user}_score_a9`) != 0) {    //change a>c or 1>2
...
if (!localStorage.getItem(`${user}_score_a9`)) {   //change a>c or 1>2
    localStorage.setItem(`${user}_score_a9`, 0);   //change a>c or 1>2
}

let score = localStorage.getItem(`${user}_score_a9`);  //change a>c or 1>2
...
const checkAnswer = el => {
    if(el.target.dataset.id == questions[indexOfQuestion].rightAnswer) {
        ...
        localStorage.setItem(`${user}_score_a9`, score);   //change a>c or 1>2
...
const quizOver = () => {
    ...
    correctAnswer.innerHTML = localStorage.getItem(`${user}_score_a9`);  //change a>c or 1>2
